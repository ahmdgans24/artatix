                                                            ...
                                                            <div class="card">
                                                                <div class="card-block">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea rows="5" cols="5" class="form-control" name="event_description"><?= $event_edit['event_description']; ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                ...
                                                                <div class="card-block">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea rows="5" cols="5" class="form-control" name="event_sk"><?= $event_edit['event_sk']; ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group row">
                                                                        <div class="col">
