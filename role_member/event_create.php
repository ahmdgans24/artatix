                                                    ...
                                                    <form action="event_create_add.php" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="card">
                                                            <div class="card-block">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Upload Your Banner<br><small><I>uk : 1062 x 427</I></small></label>
                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <div class="input-daterange input-group" id="datepicker12">
                                                                            <input type="text" class="input-sm form-control" name="event_date_finish" placeholder=" Finish">
                                                                            <span class="input-group-addon ">
                                                                                <span class="fa fa-calendar"></span>
                                                                            </span>
                                                                        </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <div class='input-group date' id='datetimepicker31'>
                                                                            <input type='time-local' class="form-control" name="event_time_start" placeholder=" Start">
                                                                            <span class="input-group-addon ">
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <div class='input-group date' id='datetimepicker32'>
                                                                            <input type='text' class="form-control" name="event_time_finish" placeholder=" Finish">
                                                                            <span class="input-group-addon ">
                                                                                <span class="fa fa-clock-o"></span>
                                                                            </span>
                                                                        </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <textarea rows="5" cols="5" class="form-control" name="event_sk"></textarea>
                                                                    </div>
                                                                </div>
