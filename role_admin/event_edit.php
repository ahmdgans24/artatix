                                                        ...
                                                        <div class="col col-md-10">
                                                            <span>
                                                                ...
                                                                <?php if ($event['event_jenis'] == 0) {
                                                                    echo ' 
            <p class="text-c-pink" </i><b> PRIVATE</b></p>
        ';
                                                                } else {
                                                                    echo ' 
            <p class="text-c-green  " </i><b>PUBLIC</b></p>
        ';
                                                                } ?></p>
                                                            </span>
                                                        ...
                                                        <div class="col col-md-2">
                                                            <span class="card-content-span"><i class="fa fa-pencil btn-secondary btn-sm card-position" data-toggle="modal" data-target="#ModalEditSingleEvent<?= $event_id; ?>">&nbsp; &nbsp;Edit Event</i></button></a><span>
                                                    ...
                                                    <div class="row m-b-20 p-l-35 ">
                                                        ...
                                                        <div class="col-6 col-md-2">
                                                            ...
                                                            <?php if ($event['event_status'] == 0) {
                                                                echo ' 
            <p class="text-c-pink card-content-span " </i><b> NOT ACTIVE</b></p>
        ';
                                                            } else {
                                                                echo ' 
            <p class="text-c-green  card-content-span" </i><b>ACTIVE</b></p>
        ';
                                                            } ?></span>
                                                        </div>
                                                    </div>
                                                                                                        ...
                                                                                                        <div class="modal-content">
                                                                                                            ...
                                                                                                            <div class="modal-body">
                                                                                                                ...
                                                                                                                <div class="form-group row">
                                                                                                                    <label class="col-sm-4 col-form-label">Total</label>
                                                                                                                    <div class="col-sm-8">
                                                                                                                        <input type="text" name="tkt_price" class="form-control" placeholder="RP 100.000" readonly>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="form-group row">
                                                                                                                    <label class="col-sm-4 col-form-label">Ticket Status</label>
