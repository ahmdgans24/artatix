                    ...
                    <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding" style="margin-bottom: 50px">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="font-size: 12px; font-family: 'poppins', sans-serif; color: #1e2b33;  line-height: 18px;  vertical-align: top; padding:10px 0;" align="right"><small>200</small></td>
                          <!-- <td style="font-size: 12px; font-family: 'poppins', sans-serif; color: #1e2b33;  line-height: 18px;  vertical-align: top; padding:10px 0;" align="right"><small><?= $hasil_rupiah = "Rp " . number_format($invoice_tr['tkt_price'], 0, ',', '.'); ?></small></td> -->
                        </tr>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="font-size: 12px; font-family: 'poppins', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; white-space:nowrap;" width="80">
                            <!-- <strong><?= $hasil_rupiah = "Rp " . number_format($invoice_tr['tkt_price']*$invoice_tr['cart_qty'], 0, ',', '.'); ?></strong> -->
                            <strong>1</strong>
                          </td>
                        </tr>
                      </tbody>
